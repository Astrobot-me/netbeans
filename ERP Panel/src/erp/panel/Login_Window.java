...
public class Login_Window extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Admin", "Faculty", "Student", "Librarian" }));
        jComboBox1.setSelectedIndex(2);

        jButton1.setText("Already Registered? Login here");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(user.equals(username.getText())){
            ...
            System.out.println("Entered Password: "+ Arrays.toString(password.getPassword()));
            if(pass.equals(password.getText())){
                label.setText("Login Successful");
                HomeWindow hw = new HomeWindow("Aditya"); 
                hw.show(); 
                this.hide();
            }else{
